...
DEFAULT_TARGET_MAX_BLOCK_SIZE = env_integer("RAY_DATA_DEFAULT_TARGET_MAX_BLOCK_SIZE", 128 * 1024 * 1024)
...
DEFAULT_SHUFFLE_TARGET_MAX_BLOCK_SIZE = env_integer("RAY_DATA_DEFAULT_SHUFFLE_TARGET_MAX_BLOCK_SIZE", 1024 * 1024 * 1024)
...
DEFAULT_STREAMING_READ_BUFFER_SIZE = env_integer("RAY_DATA_DEFAULT_STREAMING_READ_BUFFER_SIZE", 32 * 1024 * 1024)
